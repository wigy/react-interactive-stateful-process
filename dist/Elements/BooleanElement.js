...
const BooleanRenderer = (props) => {
    ...
    const label = (0, interactive_elements_1.isTextElement)(element) && element.label ? element.label : ((0, interactive_elements_1.isNamedElement)(element) ? t(`label-${element.name}`) : '');
