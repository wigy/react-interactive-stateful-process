...
exports.ProcessView = exports.ProcessStep = void 0;
...
const ProcessStep = (props) => {
    ...
    (0, useAxios_1.useAxios)({ url: `${props.api}/${props.proccessId}/steps/${props.index}`, receiver: setStep });
    console.log(step);
    return react_1.default.createElement(react_1.default.Fragment, null, "STEP");
};
...
const ProcessView = (props) => {
    ...
    (0, useAxios_1.useAxios)({ url: `${props.api}/${props.proccessId}`, receiver: setProcess });
    console.log(process);
    if (!process)
        ...
        react_1.default.createElement(core_1.Table, { className: "ProcessTable" },
            react_1.default.createElement(core_1.TableHead, null,
                react_1.default.createElement(core_1.TableRow, { style: { backgroundColor: theme.palette.secondary.main } },
                    react_1.default.createElement(core_1.TableCell, { variant: "head", align: "left" }, process.id),
                    react_1.default.createElement(core_1.TableCell, { variant: "head", align: "left" }, process.created),
                    react_1.default.createElement(core_1.TableCell, { variant: "head", align: "left" }, process.name),
            ...
            react_1.default.createElement(core_1.TableBody, null,
                react_1.default.createElement(core_1.TableRow, null,
                    ...
                    react_1.default.createElement(core_1.TableCell, { align: "right" },
                        ...
                        react_1.default.createElement(core_1.Fab, { disabled: true, style: { fontSize: '140%', color: 'black', fontWeight: 'bold' } }, canChangeStep && currentStep !== null ? currentStep + 1 : react_1.default.createElement(react_1.default.Fragment, null, "&emdash;")),
